...
Scrapes 200 REAL companies at a time (no category pages, no duplicates).
Expected total: ~5,571 companies (magic number: below 6,000).
"""
...
BATCH_SIZE = 300
PROCESSOR_PATH = Path(__file__).parent.parent.parent / "processing_tech"
...
def run_processor():
    ...
    processor_bin = PROCESSOR_PATH / "target" / "release" / "processing_tech"
    ...
    try:
        ...
        env = os.environ.copy()
        env["YC_DB_PATH"] = "../scraping_tech/data/yc.sqlite"
